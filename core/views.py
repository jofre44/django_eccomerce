...
import string
import stripe
stripe.api_key = 'gia'  # settings.STRIPE_SECRET_KEY
...
class CheckoutView(View):
    def get(self, *args, **kwargs):
        try:
            ...
            messages.info(self.request, "You do not have and active order")
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    address_qs = Address.objects.filter(
                        user=self.request.user, address_type='S', deffault=True)
                    ...
                    print("User is enetering a new shipping address")
                ...
                if same_billing_address:
                    ...
                    billing_address.save()
                    orde.billing_address = billing_address
                    order.save()

                elif use_default_billing:
                    print("Using the default billing address")
                    address_qs = Address.objects.filter(
                        user=self.request.user, address_type='B', deffault=True)
                    ...
                    print("User is enetering a new billing address")
            ...
            messages.warning(self.request, "You do no haver an active order")
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            messages.warning(
                self.request, "A serious error ocurred. We have been notified.")
            return redirect("/")
...
def get_coupon(request, code):
    try:
        ...
        messages.info(request, "This coupon does no exist")
        return redirect("core:checkout")
